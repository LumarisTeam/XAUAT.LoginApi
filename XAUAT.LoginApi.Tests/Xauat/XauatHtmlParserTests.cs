...
public class XauatHtmlParserTests
{
    ...
    [Fact]
    public void ParseExamInfoVmsRaw_ShouldExtractJsArray()
    {
        const string html = """
            <script>
              var studentExamInfoVms = [{'a': 1}, {'b': 2}];
              var other = 1;
            </script>
            """;
    ...
    [Fact]
    public void ParseExamInfoVmsRaw_ShouldReturnNullWhenAbsent()
    {
        Assert.Null(XauatHtmlParser.ParseExamInfoVmsRaw("<html></html>"));
    }
